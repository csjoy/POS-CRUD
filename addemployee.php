...
<main class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="fs-3">Add Employee</div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card-header">
              ...
              if (isset($_POST["save"])) {
                ...
                if (empty($emDesignation)) {
                  ...
                  $result = employeeInput($br_id, $emDesignation, $emName, $emAdd, $emNid, $emPhone, $emEmail, $emJoiningDate, $emSalary, $pass);
                }
              }
              ?>
            </div>
            <form method="POST">
              <div class="card-body">
                ...
                <div class="mb-3 d-flex justify-content-between">
                  ...
                  <input type="text" class="form-control w-75" id="emDesignation" name="emDesignation">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emName" class="form-label w-25">Employee Name</label>
                  <input type="text" class="form-control w-75" id="emName" name="emName">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emAdd" class="form-label w-25">Employee Address</label>
                  <input type="text" class="form-control w-75" id="emAdd" name="emAdd">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emNid" class="form-label w-25">NID Number</label>
                  <input type="text" class="form-control w-75" id="emNid" name="emNid">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emPhone" class="form-label w-25">Phone Number</label>
                  <input type="text" class="form-control w-75" id="emPhone" name="emPhone">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emEmail" class="form-label w-25">Email Address</label>
                  <input type="email" class="form-control w-75" id="emEmail" name="emEmail">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emJoiningDate" class="form-label w-25">Joining Date</label>
                  <input type="date" class="form-control w-75" id="emJoiningDate" name="emJoiningDate">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                  <label for="emSalary" class="form-label w-25">Employee Salary</label>
                  <input type="text" class="form-control w-75" id="emSalary" name="emSalary">
                </div>
                <div class="mb-3 d-flex justify-content-between">
